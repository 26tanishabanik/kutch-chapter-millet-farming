...
PROFILE_IMAGE="https://omdena.com/wp-content/uploads/2021/05/India.png.webp"

BACKGROUND_IMAGE="https://omdena.com/wp-content/uploads/2023/04/crops-philippiness-1-scaled.jpeg"

PAGE_TITLE="Precision Millet Farming: Leveraging Geospatial Technology to Optimize Crop Selection and Yield"

FOOTER_TEXT=f"Project by Omdena Kutch, India Chapter - {date.today().year}"
...
def main_header():
  with st.container():
      ...
      with left_side:
          st.image(PROFILE_IMAGE, width=250, height=250)          
      with right_side:
